...
import com.jzr.bedside.view.utils.Constant;
import com.jzr.bedside.view.utils.MiscUtil;
...
//        }
        if (mPrePercent == 0.0f || Math.abs(mPercent - mPrePercent) >= 0.01f) {
            mPercentValue = String.format("%.0f", mPercent);
            mPercentValue = mPercentValue +"BPM";
